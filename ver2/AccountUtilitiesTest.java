...
public class AccountUtilitiesTest {
	...
	public static void main(String[] args) {
		...
		testGetLargestAccount();
	}
	
	public static void testGetLargestBalance() {
		System.out.println("testGetLarestBalace(accounts)");
	...
	public static void testGetLargestAccount() {
		System.out.println("\ntestGetLargestAccount(accounts1, accounts2)");
		...
		// Create AccounUtilities
		AccountUtilities util = new AccountUtilities();
		
		// Test the method
		Account[] largest = util.getLargestAccounts(accounts1, accounts2);
		
		System.out.println("Should be: Pike, Uknown, Ivy");
